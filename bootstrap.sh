...
[ -z "$REPO_URI" ] && REPO_URI='https://github.com/double12gzh/spf13-vim.git'
[ -z "$REPO_BRANCH" ] && REPO_BRANCH='3.0-use-asyncomplete'
debug_mode='0'
fork_maintainer='1'
...
install_pkg() {
    ...
    ubuntu)
        # ALE shell checker
        sudo apt-get install -y shellcheck highlight global universal-ctags ctags
        ;;
    centos)
        yumdnf="yum"
